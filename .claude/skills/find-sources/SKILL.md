...
`/first-issue` (if typing that isn't recognized — wrong launch folder in the
Claude Code terminal, or any Claude Cowork/desktop session — say "read
.claude/skills/first-issue/SKILL.md and follow it"; that form works everywhere).
